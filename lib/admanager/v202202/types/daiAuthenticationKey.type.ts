import { DaiAuthenticationKeyStatus, DaiAuthenticationKeyType } from '../enums';
 ...
 */
export type DaiAuthenticationKeyAction =
  | 'ActivateDaiAuthenticationKeys'
  | 'DeactivateDaiAuthenticationKeys';
